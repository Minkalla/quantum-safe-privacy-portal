...
mod ffi_tests {
    ...
    use qynauth_pqc::ffi::{
        dilithium_buffer_free, dilithium_keypair_free, dilithium_keypair_generate, dilithium_sign,
        dilithium_verify, kyber_decapsulate, kyber_encapsulate, kyber_keypair_free,
        kyber_keypair_generate, memory::FFIErrorCode,
    };
